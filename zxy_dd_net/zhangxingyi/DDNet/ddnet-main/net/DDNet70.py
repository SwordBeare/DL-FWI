...
class LossDDNet:
    def __init__(self, weights=[1, 1], entropy_weight=[1, 1]):
        ...
        # For multi-classification, the current issue is a binary problem (either black or white).
    ...
    def __call__(self, outputs1, outputs2, targets1, targets2):
        ...
        :param outputs2: Velocity open_fwi_data
        :param targets1: Output of the second decoder
        :param targets2: Profile of the speed open_fwi_data
        :return:
        '''
