...
def load_dataset(stage = 3):
    ...
    print("· Dimensions of velocity open_fwi_data: ({},{},{},{})".format(train_size, classes, model_dim[0], model_dim[1]))
    print("---------------------------------")
...
def train_for_one_stage(cur_epochs, model, training_loader, optimizer, save_times = 1, key_word = "CLstage1", model_type = "DDNet"):
    ...
    for epoch in range(cur_epochs):
        ...
        if (epoch + 1) % save_epoch == 0:
            ...
            print('[' + key_word + '] Trained open_fwi_data saved: %d percent completed' % int((epoch + 1) * 100 / cur_epochs))
...
if __name__ == "__main__":
    path = ''
    path = r'D:\Allresult\models\SEGSimulationmodel\SEGSimulation_CLstage1_TrSize1600_AllEpo200_CurEpo100.pkl'
    net_model, device, optimizer = determine_network(path, model_type='DDNet')
