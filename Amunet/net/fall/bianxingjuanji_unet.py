...
class bianxingjuanji_unet(nn.Module):
    def __init__(self, n_classes, in_channels, is_deconv, is_batchnorm):
        ...
        :param is_batchnorm:    Whether to use BN
        '''
        super(bianxingjuanji_unet, self).__init__()
...
if __name__ == '__main__':
    ...
    model = bianxingjuanji_unet(n_classes=1, in_channels=29, is_deconv=True, is_batchnorm=True)
    out = model(x, [201, 301])
    print("out: ", out.size())
