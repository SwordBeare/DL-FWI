...
class bianxin_conv70(nn.Module):
    def __init__(self, n_classes, in_channels, is_deconv, is_batchnorm):
        ...
        :param is_batchnorm:    Whether to use BN
        '''
        super(bianxin_conv70, self).__init__()
        ...
        self.conv1 = unetConv11(32, filters[0], self.is_batchnorm)
        self.conv2 = unetConv2(filters[0], filters[1], self.is_batchnorm)
        self.conv3 = unetConv11(filters[1], filters[2], self.is_batchnorm)
...
if __name__ == '__main__':
    ...
    model = bianxin_conv70(n_classes=1, in_channels=5, is_deconv=True, is_batchnorm=True)
    out = model(x)
    print("out: ", out.size())
