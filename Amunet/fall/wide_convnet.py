...
class unetConv21(nn.Module):
    def __init__(self, in_size, out_size, is_batchnorm):
        ...
        :param is_batchnorm:    Whether to use BN
        '''
        super(unetConv21, self).__init__()
        if is_batchnorm:
...
class wide_convnet(nn.Module):
    def __init__(self, n_classes, in_channels, is_deconv, is_batchnorm):
        ...
        :param is_batchnorm:    Whether to use BN
        '''
        super(wide_convnet, self).__init__()
        ...
        self.center = unetConv21(filters[3], filters[4], self.is_batchnorm)
...
if __name__ == '__main__':
    ...
    model = wide_convnet(n_classes=1, in_channels=29, is_deconv=True, is_batchnorm=True)
    out = model(x, [201, 301])
    print("out: ", out.size())
